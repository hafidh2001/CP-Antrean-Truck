...
class TDeliveryOrder extends ActiveRecord
{
	...
	{
		return array(
			'tDeliveryOrderLines' => array(self::HAS_MANY, 'TDeliveryOrderLine', 'do_id'),
		);
	}
	...
	public static function getAndSaveDo($nopol){
	    vdump($nopol);
	    echo 'asdasda';
	    die();
